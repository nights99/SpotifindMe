...
AD_Data_ID1="53 70 6f 74 69 66 69 6e 64 4d 65 00 00 00 00 00"    # Organizational identifier as 16-byte UUID value
#            S  p  o  t  i  f  i  n  d  M  e
AD_Data_ID2="00 01"    # Beacon Group as 2-byte value
AD_Data_ID3="00 01"    # Beacon Unit as 2-byte value
AD_Data_Reference_RSSI="ca"    # Signed 1-byte value representing the average received signal strength at 1m from the advertiser
